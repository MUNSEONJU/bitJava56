// 인스턴스 메서드 : 
//	인스턴스가 있어야만 호출할 수 있는 메서드
//	메서드를 호출할 때 반드시 메서드 이름 앞에 반드시 인스턴스 주소를 주어야한다
//	인스턴스 주소는 그 호출되는 메서드의 숨겨진 변수 this에 저장된다.
//	static을 붙여서는 안된다 (static은 클래스메서드에 붙인다)
...
public class Calculator04 {
	...
	public void init(/*Calculator04 this*/int value){ // this는 인스턴스 주소가 저장된다
		this.result = value; // 생성된 인스턴스 주소를 알아서 this로 넘겨준다
	}
