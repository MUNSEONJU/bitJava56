...
public class Test06_ex1 {
	...
	public static void main(String[] args) {
		//문제1. 클래스는 언제 로딩되는가?
		// - 레퍼런스 변수를 선언하면 로딩되는가? 그렇지않다
		//		: 레퍼런스 변수의 선언은 클래스를 로딩하지 않는다..! 아래참조
		A p = null; // null은 메모리를 0으로 설정하라는 의미다.
		
		// - new 명령을 통해 인스턴스를 생성하려면 클래스가 필요하므로 로딩한다.
		//new A();
		
		// - 클래스 변수나 메서드 사용하기위해 클래스를 로딩한다.
