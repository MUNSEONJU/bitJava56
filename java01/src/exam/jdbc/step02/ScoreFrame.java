...
public class ScoreFrame extends Frame implements ActionListener {
	...
	public ScoreFrame() {
		this.setTitle("BIT SCORE MANAGEMENT SYSTEM");
		...
		this.add(createRowPanel("KOREAN", tfKor));
		this.add(createRowPanel("ENGLISH", tfEng));
		this.add(createRowPanel("MATHAMATICS", tfMath));

		Panel toolbar = new Panel(new FlowLayout(FlowLayout.LEFT));

		Button btn = createToolbarButton("AddScore");
